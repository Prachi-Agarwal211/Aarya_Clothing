...
export default function Home() {
  ...
  const categoriesList = [
    { name: "Kurti Set", path: "/categories/kurti-set" },
    { name: "Cord Sets", path: "#" },
    { name: "Gowns", path: "#" },
    { name: "Sarees", path: "#" },
    { name: "Kurtis", path: "#" },
                ...
                <div key={link.name} className="relative">
                  {link.hasDropdown ? (
                    <div className="relative group">
                      ...
                      {/* Dropdown Menu */}
                      <div
                        className={`absolute top-full left-0 mt-2 w-48 bg-[#1A1A1A] border border-[#D4AF37]/20 rounded-lg shadow-lg transition-all duration-200 z-50 ${categoriesDropdownOpen ? 'opacity-100 visible translate-y-0' : 'opacity-0 invisible -translate-y-2'
                          }`}
                        onMouseEnter={() => setCategoriesDropdownOpen(true)}
                        onMouseLeave={() => setCategoriesDropdownOpen(false)}
                      >
