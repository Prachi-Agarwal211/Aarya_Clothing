...
class WhatsAppService:
    ...
    def _format_phone_number(self, phone: str) -> str:
        ...
        if not phone.startswith('+'):
            # Assume US/India - you may want to make this configurable
            if len(phone) == 10:
                phone = f"+1{phone}"  # US number
            elif len(phone) == 12:
                phone = f"+{phone}"
            else:
                phone = f"+{phone}"
    ...
    def send_otp(
        ...
        try:
            ...
            # Log error (you may want to use proper logging here)
...
try:
    ...
    print(f"[WhatsApp Service] Not initialized: {str(e)}")
